...
const SCREENS = [
  {
    ...
    content: (
      <div style={{ padding: '14px 12px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
        {/* Morning Brief card — matches the screenshot provided */}
        ...
        <div style={{ background: colors.surfaceBg, border: `1px solid ${colors.borderLight}`, borderRadius: '10px', padding: '10px' }}>
          <div style={{ width: '55%', height: '9px', background: '#E5E5E5', borderRadius: '4px', marginBottom: '6px' }} />
          <div style={{ width: '75%', height: '7px', background: '#F0F0F0', borderRadius: '4px' }} />
        </div>
        <div style={{ background: colors.surfaceBg, border: `1px solid ${colors.borderLight}`, borderRadius: '10px', padding: '10px' }}>
          <div style={{ width: '65%', height: '9px', background: '#E5E5E5', borderRadius: '4px', marginBottom: '6px' }} />
    ...
    content: (
      <div style={{ padding: '14px 12px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
        ...
        <div style={{ background: colors.primary, borderRadius: '10px', padding: '11px', textAlign: 'center' }}>
          <span style={{ fontSize: '12px', fontWeight: 700, color: colors.surfaceWhite }}>Send Estimate</span>
        </div>
      </div>
    ),
  },
      ...
      <div style={{ padding: '14px 12px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
        ...
        <div style={{ display: 'flex', gap: '8px' }}>
          ...
          <div style={{ flex: 1, background: colors.primary, borderRadius: '10px', padding: '10px', textAlign: 'center' }}>
            <span style={{ fontSize: '11px', fontWeight: 700, color: colors.surfaceWhite }}>Mark Paid</span>
          </div>
        </div>
...
/**
 * MobileMechanicSection — auto-scrolling phone mockup.
 * Cycles through 4 illustrative app screens every 3.5s with a smooth
 * vertical slide transition. All data is sample/illustrative.
 * Native apps are never claimed live — PWA only (public/manifest.json confirmed).
 */
      ...
      <div style={container} className="rd1-two-col">
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          ...
          >
            ...
            {/* Screen glass — slightly inset from frame */}
            <div style={{
              borderRadius: '42px',
              overflow: 'hidden',
